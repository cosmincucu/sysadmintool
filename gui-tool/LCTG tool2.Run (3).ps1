...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       6/15/2016 11:38 AM
     Generated by:        
     Organization:        
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
"@ | Out-Null
	...
	$MyToolsErrorLogFile = $ErrorLogPathTextbox.Text
	$MyToolsLogFile = $LogPathTextBox.Text
	$progress_bar.AppendText("$MyToolsErrorLogFile and $MyToolsLogFile !")
...
")
	...
	$ErrorLogPathTextbox.Size = '100, 18'
